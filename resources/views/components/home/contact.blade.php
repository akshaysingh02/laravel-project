      ...
      <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
        <div class="max-w-[570px] mb-12 lg:mb-0">
          <h2 class="text-dark dark:text-gray-100 mb-6 uppercase font-bold text-[32px] sm:text-[40px] lg:text-[36px] xl:text-[40px]">
            Need help with Web Projects?
          </h2>
          <p class="text-base text-body-color dark:text-gray-200 leading-relaxed mb-9">
            Don't hesitate to contact me for enquiry or full time project/Job.
          </p>
          <div class="flex mb-8 max-w-[370px] w-full">
            ...
            <div class="w-full">
              ...
              <p class="text-base text-body-color dark:text-gray-300">ww.akshay@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
